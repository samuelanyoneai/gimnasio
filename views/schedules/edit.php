...
<form method="POST" action="/index.php?controller=schedule&action=update" class="form">
    ...
    <div class="form-group">
        ...
        <select id="day_of_week" name="day_of_week" required 
            ...
            <option value="Miércoles" <?php echo $schedule['day_of_week'] === 'Miércoles' ? 'selected' : ''; ?>>Miércoles</option>
            ...
            <option value="Sábado" <?php echo $schedule['day_of_week'] === 'Sábado' ? 'selected' : ''; ?>>Sábado</option>
